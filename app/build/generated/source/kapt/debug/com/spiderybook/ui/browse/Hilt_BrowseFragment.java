...
public abstract class Hilt_BrowseFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BrowseFragment_GeneratedInjector) this.generatedComponent()).injectBrowseFragment(UnsafeCasts.<BrowseFragment>unsafeCast(this));
    }
  }
