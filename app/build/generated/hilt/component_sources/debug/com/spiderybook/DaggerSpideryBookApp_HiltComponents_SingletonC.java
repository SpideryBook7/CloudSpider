...
import com.spiderybook.ui.browse.BrowseFragment;
import com.spiderybook.ui.browse.BrowseViewModel;
import com.spiderybook.ui.browse.BrowseViewModel_HiltModules;
import com.spiderybook.ui.downloads.DownloadsFragment;
import com.spiderybook.ui.favorites.FavoritesFragment;
import com.spiderybook.ui.favorites.FavoritesViewModel;
import com.spiderybook.ui.favorites.FavoritesViewModel_HiltModules;
import com.spiderybook.ui.history.HistoryFragment;
import com.spiderybook.ui.history.HistoryViewModel;
...
import com.spiderybook.ui.player.PlayerActivity_MembersInjector;
...
public final class DaggerSpideryBookApp_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends SpideryBookApp_HiltComponents.ActivityC {
    ...
    @CanIgnoreReturnValue
    private PlayerActivity injectPlayerActivity2(PlayerActivity instance) {
      PlayerActivity_MembersInjector.injectLocalRepository(instance, singletonCImpl.localRepositoryProvider.get());
      return instance;
    }
  ...
  private static final class ViewModelCImpl extends SpideryBookApp_HiltComponents.ViewModelC {
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.spiderybook.ui.browse.BrowseViewModel 
          return (T) new BrowseViewModel(new AnimeFlvProvider());

          case 1: // com.spiderybook.ui.favorites.FavoritesViewModel 
          return (T) new FavoritesViewModel(singletonCImpl.localRepositoryProvider.get());

          case 2: // com.spiderybook.ui.history.HistoryViewModel 
          ...
          case 5: // com.spiderybook.ui.result.ResultViewModel 
  ...
  private static final class SingletonCImpl extends SpideryBookApp_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      ...
      this.provideMainDaoProvider = DoubleCheck.provider(new SwitchingProvider<MainDao>(singletonCImpl, 1));
      this.localRepositoryProvider = DoubleCheck.provider(new SwitchingProvider<LocalRepository>(singletonCImpl, 0));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.spiderybook.data.repository.LocalRepository 
          return (T) new LocalRepository(singletonCImpl.provideMainDaoProvider.get());

          case 1: // com.spiderybook.data.local.dao.MainDao 
          return (T) DatabaseModule_ProvideMainDaoFactory.provideMainDao(singletonCImpl.provideDatabaseProvider.get());

          case 2: // com.spiderybook.data.local.AppDatabase 
          ...
          case 3: // com.spiderybook.data.manager.AppDownloadManager 
          ...
          case 4: // com.spiderybook.data.repository.HomeRepository 
